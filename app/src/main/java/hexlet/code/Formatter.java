...
public final class Formatter {
    public static String formatString(List<Status> differEntryList, String format) throws IOException {
    ...
    private static StringFormatter getFormatter(String format) throws IOException {
        return switch (format) {
            ...
            case "json" -> new Json();
            default -> throw new IOException("File should have 'stylish', 'plain' or 'json' format! (was '%s')"
                    .formatted(format));
        };
    }
}
